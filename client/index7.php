      ...
      <!-- <div class="row">
        <div class="col-2">
          <div class="form-group">
            ...
            <input type="checkbox" name="select_all" id="select_all" onclick='selects()' value="all" style="zoom:1.5">
            Select All Cases
          </div>
        </div>
        <div class="col-3">
        ...
        <div class="table table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $clientid = $_SESSION['user_id'];
              $i = 0;
              $sql = "SELECT * FROM orders where user_id='$clientid' and status='QC Required'";
