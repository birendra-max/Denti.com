        ...
        <div class="table table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $clientid = $_SESSION['user_id'];
              $i = 0;
              $sql = "SELECT * FROM orders where user_id='$clientid' and status='progress'";
              ...
              ?>
                <tr>
                  <td>
                    <input type="checkbox" name="caseid" class="caseid" id="caseid<?php echo $i ?>" value="<?php echo $i ?>" style="zoom:1.5"><span id="orderid"> <?php echo $row['orderid'] ?></span>
                  ...
                  <td> <i class="fas fa-clock"> </i>
                    <div class="progress">
                      <div
                        class="progress-bar <?php if ($row['status'] == 'New')
                                            ...
                                            if ($row['status'] == 'Redesign')
                                              echo 'bg-warning'; ?>"
                        style="width:<?php if ($row['status'] == 'New')
                                        echo '100%';
                                      if ($row['status'] == 'Cancel')
                                        echo '100%';
                                      if ($row['status'] == 'Completed')
