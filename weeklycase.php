                ...
                <div class="table table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $clientid = $_SESSION['user_id'];
                            $i = 0;
                            $sql = "SELECT * FROM orders  WHERE user_id='$clientid' and STR_TO_DATE(created_at, '%Y-%m-%d') >= CURDATE() - INTERVAL 7 DAY";
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="caseid" class="caseid" id="caseid<?php echo $i ?>"
                                            value="<?php echo $i ?>" style="zoom:1.5"><span id="orderid"> <?php echo $row['orderid'] ?></span>
