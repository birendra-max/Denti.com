            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="card" id="cardd">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div id="drag_drop" style="font-weight: bold;">Fast, smooth, and stress-free! ⚡ Drag and Drop files here—our team is waiting to get started with top-quality results!</div>
                                <center>
